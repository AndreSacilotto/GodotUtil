...
partial class Easing
{
    ...
    {
        var bez = new BezierCurveChromium(control.X, control.Y, control.X, control.Y);
        //var bez = new BezierCurveMozilla(control.X, control.Y, control.X, control.Y);
    ...
    {
        var bez = new BezierCurveChromium(control0.X, control0.Y, control1.X, control1.Y);
        //var bez = new BezierCurveMozilla(control0.X, control0.Y, control1.X, control1.Y);
