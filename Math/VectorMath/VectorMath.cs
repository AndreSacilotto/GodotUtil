...
namespace Util.Vector
{
    public static class VectorMath
    {
        ...
        public static Vector2 DegreeToVector(float degree) => RadianToVector2(MathUtil.TAU_01 * degree);
        ...
        public static float TauAtan2(float y, float x) => (float)Math.Atan2(y, x) + MathUtil.TAU_180;
